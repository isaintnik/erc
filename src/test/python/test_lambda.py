...
def test_one_project_py_cpp():
    ...
    lambdas = lambda_calc.calc_lambdas(0, 0, history[0], users[0], beta, interactions, projects)
    ...
    native_lambdas = lambda_calc.calc_lambdas_native(rev_projects_index[0], project_ids, n_tasks, time_deltas, users[0], dim, beta,
